...
class Account extends Controller
{
    ...
    function registerApi()
    {
        ...
        $body = 'Click vào đây để hoàn thành đăng ký của bạn: <a href="http://localhost/WebBanOto/signup-comfirm/' . $token . '">Xác nhận</a> Đường dẫn sẽ hết hạn trong 15 phút.';
    ...
    function forgotPasswordApi()
    {
        ...
        $body = 'Click vào đây để xác nhận email của bạn: <a href="http://localhost/WebBanOto/account/finalForgotPassword/' . $token . '">Xác nhận</a> Đường dẫn sẽ hết hạn trong 15 phút.';
